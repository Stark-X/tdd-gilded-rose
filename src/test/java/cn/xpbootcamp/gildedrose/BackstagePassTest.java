...
public class BackstagePassTest {
    ...
    void should_quality_enhance_1_and_sellIn_reduce_1_when_a_day_pass_given_backstage_pass_quality_is_less_than_50_and_sellIn_is_greater_than_10() {
        ...
        BackstagePassGoods goods = (BackstagePassGoods) Goods.createGoods("BackstagePass", oldQuality, oldSellIn);
        goods.updateByDay();
    ...
    @Test
    void should_quality_is_50_and_sellIn_reduce_1_when_a_day_pass_given_backstage_pass_quality_is_less_than_48_and_sellIn_is_greater_than_1_less_equal_than_5() {
        double oldQuality = 47;
        int oldSellIn = 1;
    ...
    @Test
    void should_quality_is_50_and_sellIn_reduce_1_when_a_day_pass_given_backstage_pass_quality_is_any_and_sellIn_is_less_than_0() {
        double oldQuality = 47;
        int oldSellIn = 0;
